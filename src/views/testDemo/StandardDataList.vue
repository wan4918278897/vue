<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('标准库')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <standardData-modal ref="modalForm" @ok="modalFormOk"></standardData-modal>
  </a-card>
</template>

<script>
  import StandardDataModal from './modules/StandardDataModal'
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/testDemo/standardData/list",
