      ...
      <a-card :bordered="false">
        <a-form :form="form">
          <a-form-item
            ...
            label="机构名称"
            help="">
            <a-input disabled placeholder="请输入机构/部门名称" v-decorator="['departName', validatorRules.departName ]"/>
          </a-form-item>
          ...
          <a-form-item
            ...
            label="值班电话"
            help="">
            <a-input placeholder="请输入值班电话" v-decorator="['mobile', {rules: [{ required: true}]}]"/>
          </a-form-item>
          <a-form-item
            :labelCol="labelCol"
            :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    methods: {
      ...
      onSelect(selectedKeys, e) {
        ...
        console.log('CS:',this.currSelected)
      ...
      setValuesToForm(record) {
        ...
        console.log('org:',record.orgCode)
