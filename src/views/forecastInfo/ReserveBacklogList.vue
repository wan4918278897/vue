      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-divider type="vertical"/>
            <a-popconfirm title="确定过审吗?" @confirm="() => approved(record.id,1)">
              <a>过审</a>
            </a-popconfirm>
          <a-divider type="vertical"/>
          <a-popconfirm title="确定回绝吗?" @confirm="() => approved(record.id,2)">
              <a>回绝</a>
          </a-popconfirm>
        </span>
      </a-table>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/forecastInfo/reserveInfo/backLogList",
    ...
    methods: {
      ...
      approved(id, result) {
        ...
        postAction(this.url.approved, params).then((res) => {
          if (res.success) {
