<template>
  <div class="login_wrapper">
    <div class="top">
      <div class="header">
        <a href="/">
          ...
          <span class="title">顺义区公安局园区应急值守系统</span>
        </a>
      </div>
    ...
    <a-form :form="form" class="user-layout-login" ref="formLogin" id="formLogin">
      ...
      <a-row :gutter="0" v-show="showVerificationCode==true">
        <a-col :span="14">
          <a-form-item>
            <a-input
      ...
      <a-form-item>
        <a-checkbox class="whiteText" v-model="formLogin.rememberMe">自动登陆</a-checkbox>
      </a-form-item>
...
.login_wrapper {
  ...
  form {
    ...
    box-shadow: 0 0 1px #000 outset;
    margin-top:40px;
  }
  .whiteText .ant-checkbox + span {
    color: #fff !important;
  }
}
</style>
